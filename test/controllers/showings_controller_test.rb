...
class ShowingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create showing" do
    assert_difference('Showing.count') do
      post showings_url, params: { showing: { addedby: @showing.addedby, filmname: @showing.filmname, screenname: @showing.screenname, slot: @showing.slot } }
    end
  ...
  test "should update showing" do
    patch showing_url(@showing), params: { showing: { addedby: @showing.addedby, filmname: @showing.filmname, screenname: @showing.screenname, slot: @showing.slot } }
